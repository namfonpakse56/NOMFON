<script setup>
// ไอคอนสไตล์เส้น (line/stroke) มินิมอล แนว Banking & Finance
// สีคุมด้วย currentColor (ตั้ง color ที่ตัวหุ้ม), ขนาดด้วย size
defineProps({
...
<template>
  <svg
    ...
    style="display:inline-block;vertical-align:middle;flex:none"
    aria-hidden="true"
  >
